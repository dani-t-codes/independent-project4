...
//   return this.totalCost;  //can't take out "return" line(s) as instruted, otherwise it breaks the code. Should make a cost [] and push to update instead? 
// };
...
//     let userCost = new displayCostDetails(newDreamPizza);  //this was from Brooke mtg
